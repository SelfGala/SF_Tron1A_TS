...
from bipedal_locomotion.tasks.locomotion.cfg.SF.base_env_cfg import SFEnvCfg
...
#############################
# Solefoot Rough Environment with height scan
#############################
...
#############################
# Solefoot Stair Environment with height scan
#############################

@configclass
class SFStairEnvCfgv1(SFBaseEnvCfg):
    def __post_init__(self):
        super().__post_init__()
...
@configclass
class SFStairEnvCfgv1_PLAY(SFBaseEnvCfg_PLAY):
    def __post_init__(self):
        super().__post_init__()
