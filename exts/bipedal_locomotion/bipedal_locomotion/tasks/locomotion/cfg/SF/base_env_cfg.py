...
from bipedal_locomotion.tasks.locomotion.mdp import FOV
...
class CommandCfg(BaseCommandsCfg):
    gait_command = mdp.UniformGaitCommandCfg(
        ...
        ranges=mdp.UniformGaitCommandCfg.Ranges(
            frequencies=(1.0, 2.0),  # Gait frequency range [Hz]
    ...
    def __post_init__(self):
        ...
        self.base_velocity.resampling_time_range = (3.0, 15.0)
...
class RewardsCfg:
    ...
    # penalizations
    pen_base_height = RewTerm(func=mdp.base_com_height, params={"target_height": 0.75}, weight=-1.0)
    ...
    pen_action_rate = RewTerm(func=mdp.action_rate_l2, weight=-0.05) # -0.01)
    ...
    pen_action_smoothness = RewTerm(func=mdp.ActionSmoothnessPenalty, weight=-0.1) # -0.01)
    ...
    pen_joint_power_l1 = RewTerm(func=mdp.joint_powers_l1, weight=-2.0e-5)
